...
jQuery(function($){
	...
	$('.js-open-list').on('click', function(e){
		...
		if (!$(this).hasClass('open')) {
			$(this).addClass('open').parent().find(list).slideDown()
		}
		else {
			$(this).removeClass('open').parent().find(list).slideUp()
		}
	})
	...
	$('.blog-links .white-link,.anchor-link').on('click', function(e){
        e.preventDefault();
	...
	if (wid < 890) {
		$('.blog-wrp .diskount_form_wrap .inner .right form button').text('OK')
	}
	...
	if (wid >= 1180) {
		...
		if ($('div').is('#pop-tags')) {
			let popStart = $('#pop-tags').first().parent().next().next().offset().top;

			$(window).on('scroll', function(e){
				let wScroll = $(this).scrollTop();
				
				if (wScroll >= popStart) {
					$('.side-cont #pop-tags').addClass('fixed-pop')
				}

				if (wScroll < popStart) {
					$('.side-cont #pop-tags').removeClass('fixed-pop')
				}
			})
		}
	}
	...
	if (wid < 1180) {
		...
		if ($('div').is('.pop-tags')) {
			...
			$(window).on('scroll', function(e){
				...
				if (wScroll >= popStart) {
					$('.pop-anchor').addClass('fixed')
				}

				if (wScroll < popStart) {
					$('.pop-anchor').removeClass('fixed')
				}
			})
		}
	}
	...
	new Swiper('#bizness .swiper-container', {
		navigation: {
			nextEl: '#bizness .swiper-button-next'
		},
	...
	new Swiper('.vebinars .swiper-container', {
	...
	new Swiper('.biz-table .swiper-container', {
		navigation: {
			nextEl: '.biz-table .swiper-button-next'
		},
		breakpoints: {
			320: {
		...
		speed: 800,
		pagination: {
			el: '.biz-table .swiper-pagination',
			// Буллеты
			clickable: true,
		},
		grid: {
	...
	new Swiper('.blog-raiting-100 .swiper-container', {
		navigation: {
			nextEl: '.blog-raiting-100 .swiper-button-next'
		},
	...
	new Swiper('.pops-slider .swiper-container', {
		navigation: {
			nextEl: '.pops-slider .swiper-button-next'
		},
		speed: 800,
		loop: true
	})

	new Swiper('#authors .swiper-container', {
		navigation: {
	...
	new Swiper('.media-author-wrap .mini-gallery .swiper-container', {
		breakpoints: {
			300: {
				slidesPerView: 2.5,
				spaceBetween: 10
